  ...
  <ul>
    <li>
      <NuxtLink to="/"
        ><span class="icon">
          <svg
            class="svg-inline--fa fa-heart fa-w-16 fa-fw"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
            data-icon="heart"
        ...
        ><span class="menu">Home</span></NuxtLink
      >
    </li>
    <li>
      <NuxtLink to="/order-of-service"
        ><span class="icon">
          <svg
        ...
        ><span class="menu"><span>Order of </span>Service</span></NuxtLink
      >
    </li>
    <li>
      <NuxtLink to="/tribute"
        ><span class="icon">
          <svg
            class="svg-inline--fa fa-hands-helping fa-w-20 fa-fw"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
        ...
        ><span class="menu"><span>Tribute</span> -- Jing Luo</span></NuxtLink
      >
    </li>
    <li>
      <NuxtLink to="/live-stream"
        ><span class="icon">
          <svg
            class="svg-inline--fa fa-youtube fa-w-18 fa-fw"
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="youtube"
        ...
        ><span class="menu"><span>Service </span>Livestream</span></NuxtLink
      >
    </li>
    <li>
      <NuxtLink to="/gallery"
        ><span class="icon">
          <svg
            class="svg-inline--fa fa-images fa-w-18 fa-fw"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
            data-icon="images"
        ...
        ><span class="menu">Gallery</span></NuxtLink
      >
    </li>
  </ul>
</template>
